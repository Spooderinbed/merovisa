...
// MV-157: the chrome's six signal reads are case-scoped like every other read, so
// the layout resolves and authorizes the case before calling getJourneySignals.
