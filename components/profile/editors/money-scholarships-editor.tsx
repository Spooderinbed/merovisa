  ...
  return (
    <form onSubmit={onSave} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label htmlFor="fe-total" className="text-caption uppercase tracking-wide text-ink-faint">Total funds available</label>
        <Input id="fe-total" type="number" min={0} value={total} onChange={(e) => setTotal(e.target.value)} />
      </div>
      <div className="flex flex-col gap-2">
        <label htmlFor="fe-currency" className="text-caption uppercase tracking-wide text-ink-faint">Currency</label>
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="fe-source" className="text-caption uppercase tracking-wide text-ink-faint">Source of funds</label>
      ...
      <div className="flex flex-col gap-2 border-t border-line pt-4">
        <label htmlFor="se-profile" className="text-caption uppercase tracking-wide text-ink-faint">Scholarship profile</label>
