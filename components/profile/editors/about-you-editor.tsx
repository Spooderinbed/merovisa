  ...
  return (
    <form onSubmit={onSave} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label htmlFor="pe-name" className="text-caption uppercase tracking-wide text-ink-faint">Name</label>
        <Input id="pe-name" value={name} onChange={(e) => setName(e.target.value)} />
      </div>
      <div className="flex flex-col gap-2">
        <label htmlFor="pe-age" className="text-caption uppercase tracking-wide text-ink-faint">Age</label>
        <Input id="pe-age" type="number" value={age} onChange={(e) => setAge(e.target.value)} min={15} max={80} />
      </div>
      <div className="flex flex-col gap-4 border-t border-line pt-4">
        <div className="flex flex-col gap-2">
          <label htmlFor="fme-situation" className="text-caption uppercase tracking-wide text-ink-faint">Family situation</label>
        ...
        {hasKids ? (
          <div className="flex flex-col gap-2">
            <label htmlFor="fme-children" className="text-caption uppercase tracking-wide text-ink-faint">Number of children</label>
