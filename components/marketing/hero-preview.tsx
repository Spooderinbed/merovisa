  ...
  return (
    <Card className="overflow-hidden">
      ...
      <div className="flex items-center justify-between border-b border-line bg-surface-2 px-5 py-3">
        ...
        <span className="font-mono text-caption uppercase tracking-wide text-ink-faint">preview</span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr]">
        ...
        <div className="flex flex-col gap-3 bg-surface-2 p-5">
          <span className="font-mono text-caption uppercase tracking-wide text-ink-faint">Your guide</span>
          ...
          <div className="flex flex-col gap-2">
            {["Is my gap a problem?", "How much must I show?"].map((q) => (
              <span
                key={q}
                className="inline-flex items-center justify-start rounded-pill border border-line bg-surface px-3 py-1.5 text-meta text-ink-soft"
              >
                {q}
              </span>
            ))}
