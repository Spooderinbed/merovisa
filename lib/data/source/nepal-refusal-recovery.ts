...
export const NEPAL_REFUSAL_RECOVERY: NepalRefusalRecovery[] = [
  ...
  },
  {
    ...
    kind: "recovery-path",
    label: "Review fee",
    summary: "The review has a fee — AUD 3,727 for most migration decisions.",
    value: 3727,
    unit: "AUD",
    source: ART_IMMIGRATION,
    ...
    provenance: {
      ...
      source: ART_IMMIGRATION,
      note: "ART application fee for a review of most migration decisions is AUD 3,727 (I.045), indexed annually from 1 July 2026 (was AUD 3,580).",
    },
  },
  {
