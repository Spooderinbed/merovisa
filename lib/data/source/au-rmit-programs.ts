...
export const AU_RMIT_PROGRAMS: AuRmitProgram[] = [
  ...
  // RMIT IT, business, health and education programs (international, 2026).
  {
    ...
    source: RMIT_GUIDE_SOURCE,
    lastVerified: "2026-06-07",
    provenance: { findingRefs: ["E.042", "E.043", "E.045"] },
  },
  {
  ...
  },
  {
    ...
    source: RMIT_GUIDE_SOURCE,
    lastVerified: "2026-06-07",
    provenance: { findingRefs: ["E.084", "E.085"] },
  },
  {
  ...
  },
  {
    ...
    source: RMIT_GUIDE_SOURCE,
    lastVerified: "2026-06-07",
    provenance: { findingRefs: ["E.092", "E.093"] },
  },
  {
    ...
    source: RMIT_GUIDE_SOURCE,
    lastVerified: "2026-06-07",
    provenance: { findingRefs: ["E.110", "E.111"] },
  },
  {
    ...
    source: RMIT_GUIDE_SOURCE,
    lastVerified: "2026-06-07",
    provenance: { findingRefs: ["E.117", "E.118"] },
  },
];
