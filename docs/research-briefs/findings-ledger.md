...
| C.145 | C | practitioner | process |  | pending | policy-banner scrutiny line (F2 Option A) | Sector reporting: DHA moved Nepal (with India, Bangladesh and Bhutan) from SSVF evidence level 2 to evidence … |
| C.146 | C | primary | process |  | used | policy-banner scrutiny line (F2 Option A) | DHA's public Document Checklist Tool generates the student-visa evidence list from country of passport plus e… |
| C.147 | C | practitioner | process |  | pending | policy-banner scrutiny line (F2 Option A) | DHA does not publish country or provider evidence levels: a DHA spokesperson told The PIE News provider evide… |
| C.148 | C | practitioner | data |  | pending | plan/checklist seasoning recommendation voice (F2 Option B wording) | Practitioner guidance on bank-statement seasoning under Nepal's 2026 evidence-level setting disagrees: VisaHQ… |
